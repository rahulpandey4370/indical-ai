...
import { NutritionalAnalysis } from '@/lib/types';
...
export function NutritionalChart({ analysis }: { analysis: NutritionalAnalysis }) {
  const { total_macros } = analysis;
  const { protein, carbs, fat } = total_macros;
    ...
    return (
      <Card>
          <CardHeader>
              ...
              <CardDescription>Estimated Calories: {analysis.total_calories || 'N/A'}</CardDescription>
          </CardHeader>
